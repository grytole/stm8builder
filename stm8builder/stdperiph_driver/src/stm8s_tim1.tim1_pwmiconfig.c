/**
  ******************************************************************************
  * @file    stm8s_tim1.tim1_pwmiconfig.c
                     ...
                     uint8_t TIM1_ICFilter)
{
  ...
  {
    /* TI1 Configuration */
    __TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
                 (uint8_t)TIM1_ICFilter);
    ...
    /* TI2 Configuration */
    __TI2_Config(icpolarity, icselection, TIM1_ICFilter);
  ...
  {
    /* TI2 Configuration */
    __TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSelection,
                 (uint8_t)TIM1_ICFilter);
    ...
    /* TI1 Configuration */
    __TI1_Config(icpolarity, icselection, TIM1_ICFilter);
