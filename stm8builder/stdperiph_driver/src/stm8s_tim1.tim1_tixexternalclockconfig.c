/**
  ******************************************************************************
  * @file    stm8s_tim1.tim1_tixexternalclockconfig.c
                                 ...
                                 uint8_t ICFilter)
{
  ...
  {
    __TI2_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
  }
  else
  {
    __TI1_Config((uint8_t)TIM1_ICPolarity, (uint8_t)TIM1_ICSELECTION_DIRECTTI, (uint8_t)ICFilter);
  }
