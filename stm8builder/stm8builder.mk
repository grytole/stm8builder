...
build: $(CURDIR)/$(OUTPUT_HEXFILE)

$(CURDIR)/$(OUTPUT_HEXFILE): $(BUILD_DIR) $(STDPERIPH_DRIVER_DIR)/$(STDPERIPH_DRIVER_LIB) $(OBJECTS)
	$(QUIET)$(CC) $(CFLAGS) $(LFLAGS) -o $(BUILD_DIR)/$(OUTPUT_HEXFILE) $(OBJECTS)
...
$(STM8FLASH_DIR)/$(STM8FLASH):
	$(QUIET)$(MAKE) -C $(STM8FLASH_DIR) VERBOSE=$(VERBOSE)
